...
class AdyenHistoryGetCapturedSumTest extends UnitTestCase
{
    /**
     * @covers \OxidSolutionCatalysts\Adyen\Model\AdyenHistory::getCapturedSum
     */
    public function testLoadByPSPReference()
    {
        ...
        $this->assertEquals(
            $returnValue,
            $adyenHistoryMock->getCapturedSum($pspReference)
        );
    }
}
