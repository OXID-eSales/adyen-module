...
class AdyenHistoryGetRefundedSumTest extends UnitTestCase
{
    /**
     * @covers \OxidSolutionCatalysts\Adyen\Model\AdyenHistory::getRefundedSum
     */
    public function testLoadByPSPReference()
    {
        ...
        $this->assertEquals(
            $returnValue,
            $adyenHistoryMock->getRefundedSum($pspReference)
        );
    }
}
