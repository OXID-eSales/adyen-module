...
class Email extends Email_parent
{
     ...
     * @var string
     */
    protected $adyenRefundTplHtml = "@osc_adyen/email/html/refund";
     ...
     * @var string
     */
    protected $adyenRefundTplPlain = "@osc_adyen/email/plain/refund";
     ...
     * @var string
     */
    protected $adyenCancelTplHtml = "@osc_adyen/email/html/cancel";
     ...
     * @var string
     */
    protected $adyenCancelTplPlain = "@osc_adyen/email/plain/cancel";
    /**
     * @param Order $order
    ...
    protected function sendAdyenOrderMail(
        ...
        $wasAdmin = $this->switchAdyenAdminMode(false);
        ...
        try {
            ...
            $this->switchAdyenAdminMode($wasAdmin);
            if ($mailLanguage !== null) {
     ...
     */
    protected function switchAdyenAdminMode(bool $isAdmin): bool
    {
