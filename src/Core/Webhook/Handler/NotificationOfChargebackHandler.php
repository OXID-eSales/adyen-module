...
final class NotificationOfChargebackHandler extends WebhookHandlerBase
{
    public const NOTIFICATION_OF_CHARGEBACK_EVENT_CODE = "NOTIFICATION_OF_CHARGEBACK";
    ...
    {
        return Module::ADYEN_STATUS_NOTIFICATION_OF_CHARGEBACK;
    }
}
