...
$aLang = [
    'charset' => 'UTF-8',
    'SHOP_MODULE_GROUP_osc_adyen_mails' => 'Bestätigungsmails',
    'SHOP_MODULE_osc_adyen_RefundMailRecipient' => 'Bestätigungsmail bei Rückerstattung',
    'SHOP_MODULE_osc_adyen_RefundMailRecipient_0' => 'Keine Mail versenden',
    'SHOP_MODULE_osc_adyen_RefundMailRecipient_1' => 'An den Kunden',
    'SHOP_MODULE_osc_adyen_RefundMailRecipient_2' => 'An den Shop-Betreiber',
    'SHOP_MODULE_osc_adyen_RefundMailRecipient_3' => 'An Kunden und Shop-Betreiber',
    'HELP_SHOP_MODULE_osc_adyen_RefundMailRecipient' => 'Wer wird per E-Mail informiert, wenn im Backend eine Rückerstattung ausgelöst wurde und Adyen sie angenommen hat? Das betrifft den Rückerstattungs-Button in der Bestellansicht und das Entfernen einzelner Bestellpositionen. Die Mail nennt Bestellnummer und erstatteten Betrag.',
    'SHOP_MODULE_osc_adyen_CancelMailRecipient' => 'Bestätigungsmail bei Storno',
    'SHOP_MODULE_osc_adyen_CancelMailRecipient_0' => 'Keine Mail versenden',
    'SHOP_MODULE_osc_adyen_CancelMailRecipient_1' => 'An den Kunden',
    'SHOP_MODULE_osc_adyen_CancelMailRecipient_2' => 'An den Shop-Betreiber',
    'SHOP_MODULE_osc_adyen_CancelMailRecipient_3' => 'An Kunden und Shop-Betreiber',
    'HELP_SHOP_MODULE_osc_adyen_CancelMailRecipient' => 'Wer wird per E-Mail informiert, wenn eine Adyen-Bestellung im Backend storniert wurde? Ist zum Zeitpunkt des Stornos schon Geld eingezogen, erstattet das Modul es automatisch — diese Mail nennt dann auch den erstatteten Betrag, und es wird nur diese eine Mail versendet, keine zusätzliche Rückerstattungs-Mail.',
