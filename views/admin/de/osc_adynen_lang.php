...
$aLang = [
    ...
    'OSC_ADYEN_ACTION' . Module::ADYEN_ACTION_REPORT => 'Berichte',
    ...
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_CAPTURE_FAILED => 'Erfassung fehlgeschlagen',
    ...
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_CHARGEBACK => 'Der Kunde hat für diese Bestellung eine Rückbuchung durchgeführt und der Betrag wurde von dem Händlerkonto abgezogen.',
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_NOTIFICATION_OF_CHARGEBACK => 'Der Kunde hat für diese Bestellung eine formelle Rückbuchung angekündigt und das Streitverfahren (Dispute) eröffnet. Ab jetzt läuft die Frist, in der Beweise eingereicht werden können.',
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_REFUNDED => 'Erstattet',
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_REPORT_AVAILABLE => 'Bericht verfügbar',
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_REFUNDFAILED => 'Rückerstattung fehlgeschlagen',
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_REFUND_FAILED => 'Rückerstattung fehlgeschlagen',
