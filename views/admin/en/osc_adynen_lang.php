...
$aLang = [
    ...
    'OSC_ADYEN_ACTION' . Module::ADYEN_ACTION_REPORT => 'Report',    
    ...
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_CAPTURE_FAILED => 'CaptureFailed',
    ...
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_CHARGEBACK => 'The customer initiated a chargeback for this order, and the amount was deducted from the merchant account.',
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_NOTIFICATION_OF_CHARGEBACK => 'The customer has announced a formal chargeback for this order and initiated the dispute process. The period for submitting evidence has now begun.',
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_REFUNDED => 'Refunded',
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_REPORT_AVAILABLE => 'available',
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_REFUNDFAILED => 'RefundFailed',
    'OSC_ADYEN_STATUS' . Module::ADYEN_STATUS_REFUND_FAILED => 'RefundFailed',
