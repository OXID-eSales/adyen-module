...
$aLang = [
    'charset' => 'UTF-8',
    'SHOP_MODULE_GROUP_osc_adyen_mails' => 'Confirmation mails',
    'SHOP_MODULE_osc_adyen_RefundMailRecipient' => 'Confirmation mail on refund',
    'SHOP_MODULE_osc_adyen_RefundMailRecipient_0' => 'Do not send a mail',
    'SHOP_MODULE_osc_adyen_RefundMailRecipient_1' => 'To the customer',
    'SHOP_MODULE_osc_adyen_RefundMailRecipient_2' => 'To the shop owner',
    'SHOP_MODULE_osc_adyen_RefundMailRecipient_3' => 'To customer and shop owner',
    'HELP_SHOP_MODULE_osc_adyen_RefundMailRecipient' => 'Who is notified by email once a refund was triggered in the backend and Adyen accepted it? This covers the refund button in the order view and removing single order positions. The mail states the order number and the refunded amount.',
    'SHOP_MODULE_osc_adyen_CancelMailRecipient' => 'Confirmation mail on cancellation',
    'SHOP_MODULE_osc_adyen_CancelMailRecipient_0' => 'Do not send a mail',
    'SHOP_MODULE_osc_adyen_CancelMailRecipient_1' => 'To the customer',
    'SHOP_MODULE_osc_adyen_CancelMailRecipient_2' => 'To the shop owner',
    'SHOP_MODULE_osc_adyen_CancelMailRecipient_3' => 'To customer and shop owner',
    'HELP_SHOP_MODULE_osc_adyen_CancelMailRecipient' => 'Who is notified by email once an Adyen order was cancelled in the backend? If money had already been captured at that point, the module refunds it automatically - this mail then also states the refunded amount, and only this single mail is sent, no additional refund mail.',
